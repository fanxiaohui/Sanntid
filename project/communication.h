...
void tcp_listen(); 						//Master listens for incoming TCP connections								
void *tcp_send(void *transmit);			//Client sends messages over TCP
void tcp_recieve(void *socket_desc);	//Client recieves messages over TCP	
void udp_listen();						//Master listens for new clients on network
void udp_send();						//Master broadcasts messages over UDP
