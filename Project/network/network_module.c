...
void *tcp_connection_handler(void *socket_desc) //Connection handler for TCP connections
{
    ...
    int read_size;
    char *message , client_message[500], elev_go[2000], elev_go2[2000], halla[500];
    bzero(halla,500); 
    strcpy(halla,"halla");
...
void client_init(){
    ...
    *new_sock = sockfd;
    ...
    pthread_create(&client_thread1, NULL, tcp_send, (void*) new_sock);
    pthread_create(&client_thread2, NULL, tcp_recieve, (void*) new_sock);
